...
public class Main {
    public static void main(String[] args) {
        ...
        menuBibliotecas(bibliotecas, libros);
    }
    ...
    public static void menuBibliotecas(ArrayList<Biblioteca> bibliotecas, ArrayList<Libro> libros) {
        ...
        while (salir) {
            ...
            n = bibliotecas.size();
            System.out.println("0-Gestionar una biblioteca ya existente\n1-Añadir biblioteca\n2-Salir\n"+"Actualmente hay "+n+" bibliotecas");
